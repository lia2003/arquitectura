...
def fase_grupos():
    ...
    #que no
    #En la fecha 1:
    partido("Levon", "Magnus")
    partido("Boris", "Alexander")
    partido("Peter", "Vladimir")
    #En la fecha 2:
    partido("Magnus", "Vladimir")
    partido("Alexander", "Peter")
    partido("Levon", "Boris")
    #En la fecha 3:
    partido("Boris", "Magnus")
    partido("Peter", "Levon")
    partido("Vladimir", "Alexander")
    #En la fecha 4:
    partido("Magnus", "Alexander")
    partido("Levon", "Vladimir")
    partido("Boris", "Peter")
    #En la fecha 5:
    partido("Peter", "Magnus")
    partido("Vladimir", "Boris")
    partido("Alexander", "Levon")

    #Para sacar el valor del mayor 
    mayor=0
    for i in len(puntajes):
        if puntajes[i]>mayor:
            mayor=puntajes[i]
            pocision=i
